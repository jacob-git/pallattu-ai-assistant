...
def test_tool_definitions_are_safe_function_tools():
    registry = PortableToolRegistry()
...
def test_current_time_returns_local_time():
    result = PortableToolRegistry().execute("current_time", {})
...
def test_weather_requires_location():
    result = PortableToolRegistry().execute("weather", {"location": ""})
...
def test_unknown_tool_is_rejected():
    result = PortableToolRegistry().execute("delete_everything", {})
